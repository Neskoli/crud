			...
			<dl class="dl-horizontal">
				...
				<dd><?php
						if(!empty($usuario['foto'])){
							echo "<img src=\"foto/" . $usuario['foto'] . "\" class=\"shadow p-1 mb-1 bg-body rounded\" width=\"200px\">";
						} else{
							echo "<img src=\"foto/semimagem.jpg\" class=\"shadow p-1 mb-1 bg-body rouded\" width=\"200px\">";
						}
